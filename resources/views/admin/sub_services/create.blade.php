{{-- resources/views/admin/sub_services/create.blade.php --}}
@extends('layouts.admin')

@section('content')
    <div class="container mx-auto px-4 py-6">
        <div class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
            <h2 class="text-2xl font-semibold mb-6">Add New SubService</h2>
            @if ($errors->any())
            ...
            @endif
            <form action="{{ route('admin.services.sub_services.store', ['service' => $service->id]) }}" method="POST"
